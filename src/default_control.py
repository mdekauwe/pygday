...
grazing = 0                    # Is foliage grazed? 0=No, 1=daily, 2=annual and then set disturbance_doy=doy
...
respiration_model = "FIXED"    # Plant respiration ... Fixed = 0.5, TEMPERATURE or BIOMASS
